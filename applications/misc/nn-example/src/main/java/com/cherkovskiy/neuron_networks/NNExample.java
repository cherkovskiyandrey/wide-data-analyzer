 ...
 * В каждом бандле в мавен файле перечислены api зависимости для их предварительной загрузки и сами бандлы compileOnly берут эти зависимости.
 * А так же сервисы которые он выставляет. Сервисы которые ему нужны не ясны на этапе запуска и если во время работы они потребуются а их не будет
 * выкинется ошибка.
 *
