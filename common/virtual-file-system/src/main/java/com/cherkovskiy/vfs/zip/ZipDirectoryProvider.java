...
public class ZipDirectoryProvider implements DirectoryProvider {

    private final static ImmutableList<String> SUPPORTED_EXTENSIONS = ImmutableList.of("zip", "jar");
    ...
    public Directory createInstance(String file) {
        return new ZipDirectoryImpl(file);
    }
    ...
    public MutableDirectory createMutableInstance(String file, boolean createIfNotExists) {
        return new ZipMutableDirectoryImpl(file, createIfNotExists);
    }
}
