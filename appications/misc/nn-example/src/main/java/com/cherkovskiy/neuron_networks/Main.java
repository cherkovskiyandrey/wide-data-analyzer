...
import com.cherkovskiy.application_context.ServiceVersionImpl;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException, ServiceNotFoundException {

        final ApplicationContext applicationContext = new MonolithicApplicationContext(args);

        //final NeuronNetworkService neuronNetworkService = applicationContext.getService(NeuronNetworkService.class);
        final NeuronNetworkService neuronNetworkService = applicationContext.getService(NeuronNetworkService.class, "mlp", ServiceVersionImpl.fromString("1.0-SNAPSHOT"));
